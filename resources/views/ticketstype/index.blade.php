...
<body>
        ...
        <table class="table table-primary table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form method="get" action="{{ route('ticketstype.show', ['ticketstype'=>$tickettype->id])}}">
                            <input class="btn btn-primary" type="submit" value="Mostrar">
                        </form>
                    </td>
                    <td>
                        <form method="get" action="{{ route('ticketstype.edit', ['ticketstype'=>$tickettype->id])}}">
                            <input class="btn btn-warning" type="submit" value="Editar">
                        </form>
                    </td>
                    <td>
                        <form method="post" action="{{ route('ticketstype.destroy', ['ticketstype'=>$tickettype->id])}}">
                            @csrf
                            {{ method_field('DELETE') }}
    ...
    <div class="mt-2 mb-2">
        <a href="{{ route('ticketstype.create') }}">
            <button class="btn btn-success">Crear tipo de ticket</button>
        </a>
    </div>
